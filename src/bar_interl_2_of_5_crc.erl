...
loop([Ch1] = _Chars, Values, BinAcc) ->
    Value1 = value(Ch1, ?CHARSET),
    NewValues = [Value1 | Values],
    CheckSum = calc_check_sum(NewValues),
    io:format("Values: ~w~n", [lists:reverse(NewValues)]),
